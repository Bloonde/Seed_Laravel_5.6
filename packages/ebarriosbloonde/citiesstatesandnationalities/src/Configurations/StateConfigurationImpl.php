...
class StateConfigurationImpl implements IFrameworkConfiguration
{
    /**
    ...
    public function getModelName()
    {
         ...
         * return 'Flat';
         */
        return 'EBarriosBloonde\CitiesStatesAndNationalities\State';
    }
    ...
    public function getSelectorSelect()
    {
         ...
         *          'users.name as name']
         */
        return ['states.id as id', 'states.name as name'];
    }
